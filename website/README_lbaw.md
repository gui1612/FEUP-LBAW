...
git clone https://git.fe.up.pt/lbaw/lbaw2264/lbaw2264.git
...
DB_PORT=5432
DB_SCHEMA=lbaw2264
DB_DATABASE=lbaw2264
DB_USERNAME=lbaw2264
...
```bash
docker run -it -p 8000:80 --name=lbaw2264 -e DB_DATABASE="lbaw2264" -e DB_SCHEMA="lbaw2264" -e DB_USERNAME="lbaw2264" -e DB_PASSWORD="PASSWORD" git.fe.up.pt:5050/lbaw/lbaw2223/lbaw2264
```
